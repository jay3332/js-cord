...
module.exports = class Asset {
    ...
    get urlAs({ format, size, staticFormat }) {
        format = format ? this._assertFormat(format) : this.defaultFormat;
        staticFormat = staticFormat ? this._assertFormat(staticFormat) : this.defaultFormat;
